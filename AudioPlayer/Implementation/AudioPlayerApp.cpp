...
Result AudioPlayerApp::Init(const HINSTANCE& appInstance, const ResourceManager& resourceManager) {
    ...
    LoadStringW(appInstance, IDS_APP_TITLE, newWindowConfig.title.data(), WindowConfig::MAX_RESOURCE_NAME_LENGTH);
    LoadStringW(appInstance, IDC_AUDIOPLAYER, newWindowConfig.mainWindowClassName_.data(), WindowConfig::MAX_RESOURCE_NAME_LENGTH);

...
#pragma warning( disable : 4365)    //  conversion from 'long' to 'el::base::type::LineNumber', signed / unsigned mismatch
...
#  define ELPP_FINAL
#else
#ifdef ELPP_GCC_VERSION
#  if  (ELPP_GCC_VERSION < 40702)
#  define ELPP_FINAL
#  else
...
#if (!defined (ELPP_CXX0X) && !defined(ELPP_CXX11))
